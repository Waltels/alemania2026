<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav" id="sidebarNav">
      ...
      <li class="nav-item nav-category">Unidad Educativa</li>
        <li class="nav-item {{ active_class(['ue/*']) }}">
          <a class="nav-link" data-bs-toggle="collapse" href="#ue" role="button" aria-expanded="{{ is_active_route(['ue/*']) }}" aria-controls="ue">
            <i class="link-icon" data-lucide="aperture"></i>
            <span class="link-title">Organización</span>
            <i class="link-arrow" data-lucide="chevron-down"></i>
          </a>
          <div class="collapse {{ show_class(['ue/*']) }}" data-bs-parent="#sidebarNav" id="ue">
            <ul class="nav sub-menu">
              <li class="nav-item">
                <a href="{{ url('/ue/gestions') }}" class="nav-link {{ active_class(['ue/gestions']) }}">Gestión</a>
              </li>
              <li class="nav-item">
                <a href="{{ url('/ue/nivels') }}" class="nav-link {{ active_class(['ue/nivels']) }}">Nivel</a>
              </li>
              <li class="nav-item">
                <a href="{{ url('/ue/paralelos') }}" class="nav-link {{ active_class(['ue/paralelos']) }}">Paralelo</a>
              </li>
              <li class="nav-item">
                <a href="{{ url('/ue/grados') }}" class="nav-link {{ active_class(['ue/grados']) }}">Grado</a>
              </li>
            </ul>
          </div>
        </li>
