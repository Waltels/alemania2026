...
<div class="row">
  <div class="col-md-5 grid-margin stretch-card mx-auto">
    <div class="card">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addGestionModal">
              Agregar Gestión
            </button>
      <div class="card-body">
                ...
                <tr>
                  ...
                  <td>
                    <div class="example" style="text-align: right;">
                        <button type="button" class="btn btn-primary btn-icon" data-bs-toggle="modal" data-bs-target="#editGestionModal{{ $gestion->id }}"><i data-lucide="check-square"></i></button>
                        <!-- modal para editar -->
                        <div class="modal fade" id="editGestionModal{{ $gestion->id }}" tabindex="-1" aria-labelledby="editGestionModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="editGestionModalLabel">Editar Gestión</h5>
                              ...
                              <form action="{{ route('gestions.update', $gestion->id) }}" method="POST">
                                ...
                                <div class="modal-body">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" value="{{ $gestion->nombre }}" required>
                                  </div>
                                </div>
                        ...
                        <form class="delete-form" action="{{ route('gestions.destroy', $gestion->id) }}" method="POST" style="display: inline-block;">
                          @csrf
                          @method('DELETE')
...
<div class="modal fade" id="addGestionModal" tabindex="-1" aria-labelledby="addGestionModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addGestionModalLabel">Agregar Nueva Gestión</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
